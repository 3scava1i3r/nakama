...
export interface innerDisplayTypes {
  type: 'proposals' | 'voters'
}
...
export const innerDisplayMethod = atom({
  key: 'innerDisplay',
  default: {
    type: 'proposals',
  } as innerDisplayTypes,
})
...
export const FilteredProtocols = selector({
  ...
  get: ({ get }) => {
    ...
    // console.log('okok::',protocolsList)
    // console.log('okok', protocolsList instanceof Array, [JSON.parse(JSON.stringify(protocolsList))] )
