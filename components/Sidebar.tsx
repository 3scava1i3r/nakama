...
import Box, { BoxMotion } from './shared/Box'
...
// !! fix it logic array token minus
...
const Sidebar = () => {
  ...
  if (error) {
    return <StyledContainer>Something went wrong...Try to reload the page</StyledContainer>
  }
    ...
    return (
      <Resizable
        ...
        <StyledContainer
          ...
          <Button onClick={() => setIsOpen(!isOpen)} look="outlined" color="gray" css={{ padding: '$0', marginTop: '$0' }}>
          ...
          <Box css={{ padding: '$2 0', width: '100%' }}>
            ...
            {votes?.topVoters?.map((voter: any) => {
              return (
                <Box layout="flexBoxRow" css={{ width: '100%', justifyContent: 'space-between' }} key={'voter' + voter.address}>
      ...
      <Resizable
        ...
        <StyledContainer
          ...
          <Box css={{ borderBottom: '1px solid rgba(0,0,0,0.3)', padding: '$2 0' }}>
            <Box as="h5" css={{ display: 'flex', cursor: 'pointer', gap: '$1', alignItems: 'center' }}>
              {' '}
              Global Stats
            </Box>
            <Box
              ...
              <p>Total Proposals</p>
              <Box layout="flexBoxRow" css={{ gap: '$0' }} as="p">
                {data?.data.totalProposals}
                <svg style={{ color: 'rgba(0,0,0,0.39)' }} width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path
          ...
          <Box css={{ borderBottom: '1px solid rgba(0,0,0,0.3)', padding: '$2 0' }}>
            ...
            {[...protocols]
              .sort((a: any, b: any) => b.uniqueVoters - a.uniqueVoters)
              .slice(0, 10)
              .map((i: any) => (
                <Box
                  layout="flexBoxRow"
          ...
          <Box css={{ borderBottom: '1px solid rgba(0,0,0,0.3)', padding: '$2 0' }}>
            ...
            {[...protocols]
              .sort((a: any, b: any) => b.totalProposals - a.totalProposals)
              .slice(0, 10)
              .map((i: any) => (
                <Box
                  layout="flexBoxRow"
  ...
  return (
    <Box css={{ padding: '$2 $1 0 0', overflow: 'visible', width: 'auto', position: 'relative', top: '0', right: '0' }}>
      <Button css={{ position: 'relative', padding: '$0', marginTop: '$0' }} onClick={() => setIsOpen(!isOpen)} look="outlined" color="gray">
        <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
