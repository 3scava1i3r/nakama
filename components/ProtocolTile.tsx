        ...
        <StyledProtocolContainer
          ...
          <StyledHeader selected={selected}>
            <Box
              ...
              {icons && (
                <motion.img
                  ...
                  style={{
                    ...
                    borderRadius: '30px',
                    boxShadow: `0 0 0 0.07em #000000, 0 0 0 0.13em #FFFFFF, 0 1px 5px 0.07em hsl(${charToColor(name)}, 75%, 47%) `,
                  }}
                  alt={name + 'icon'}
                  src={icons[0].url}
                />
              ...
              <StyledTitle selected={selected}>{name}</StyledTitle>
            </Box>
          ...
          {selected && (
            <BoxMotion
              ...
              <ProtocolData container={container} background={background} border={border} shadow={shadow} name={cname} />
            </BoxMotion>
          )}
        </StyledProtocolContainer>
      </Box>
