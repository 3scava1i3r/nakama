...
const Home: NextPage = ({ selected}:Props) => {
  ...
  const { data, error, isValidating } = useSWR(selected !== null ? `https://api.boardroom.info/v1/protocols/${selected}` : `https://api.boardroom.info/v1/protocols`, fetcher,{ refreshInterval: 1000 })
